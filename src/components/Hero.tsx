    ...
    <section id="topo" className="bg-white">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 pt-24 md:pt-28 pb-10 md:pb-14">
        <div className="grid md:grid-cols-2 md:min-h-[640px] items-stretch overflow-hidden rounded-3xl border border-brand-navy/10 bg-brand-bg">
          ...
          <div className="order-1 md:order-2 flex flex-col justify-center px-7 py-12 sm:px-12 md:px-14 md:py-0 bg-white">
            <span className="eyebrow">Ribeirão das Neves, MG</span>
            <h1 className="font-display mt-6 text-[2.5rem] sm:text-5xl md:text-[3.75rem] text-brand-navy max-w-[560px]">
              Um novo olhar
              <br />
              para cuidar da
              <br />
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              ...
              <a
                href="#atendimentos"
                className="inline-flex items-center justify-center rounded-2xl px-6 py-3.5 text-base font-medium text-brand-navy border border-brand-navy/15 hover:bg-white hover:border-brand-navy/25 transition-colors min-h-11"
              >
                Ver atendimentos
              </a>
            </div>
